...
# data folder:
csv_prepared_folder="/home/projects/vokquant/accent-recog-slt2022/CommonAccent/data/at_augmented_dialektfamilie"
...
if [ "$apply_augmentation" == 'True' ]; then
    ...
    rir_folder="/home/projects/vokquant/accent-recog-slt2022/CommonAccent/data/rir_folder/"
else
...
$cmd python3 accent_id/train_w2v2.py accent_id/hparams/train_w2v2_xlsr_at_fam.yaml \
    --seed=$seed \
    --skip_prep="True" \
