...
mkdir -p /home/projects/vokquant/data/dicla/augmented_ofai_cv/ && \
...
tar --use-compress-program=pigz -xf /home/projects/vokquant/data/at_augmented_ofai_cv/at_augmented_ofai_cv.tar.gz -C /home/projects/vokquant/data/dicla/augmented_ofai_cv/
